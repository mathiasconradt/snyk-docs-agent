...
Base URL for CLI download: Specify an alternative download host for the CLI, for example, https://downloads.snyk.io/fips. This must provide the CLI and necessary files as the default https://downloads.snyk.io does, that is, the following files. See also GitHub releases.
...
%Base URL%/cli/stable/ls-protocol-version-%PROTOCOL_VERSION%
