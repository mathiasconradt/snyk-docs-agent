Log in to your Snyk account and navigate to the relevant Group and Organization you want to manage.
Navigate to the Projects page and click Add Projects.\
...
Select one or multiple images using any or all of the following methods:
...
7. You can now connect your Git repository to this Project in order to use your Dockerfile for enriched fix advice. For more information, see Detect vulnerable base images from your Dockerfile.
