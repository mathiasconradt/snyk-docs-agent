...
In Snyk, retrieve and copy the IDs for any additional Snyk Organizations that you want to integrate and save the IDs so you can paste them into a script in the subsequent steps.
In AWS, navigate to the Trust relationships tab for the role you want to update with additional Organizations.
