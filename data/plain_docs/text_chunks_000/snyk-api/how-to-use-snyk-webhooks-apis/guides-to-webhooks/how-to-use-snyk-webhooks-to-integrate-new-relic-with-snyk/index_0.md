...
Through New Relic's native security ingest processor: follow the guide on New Relic docs to get started
Through an Azure Function App that acts as a proxy: begin with Create an Azure Function App.
