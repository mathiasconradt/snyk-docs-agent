...
Filter configuration for coverage control
...
Filter configuration for coverage control
In the Inventory view, any coverage gap is indicated with strikes through the control coverage icon. See more details about each icon on the Inventory capabilities page.
