...
Beginning with Broker version 4.166.0 (2023-10-10), the custom CA cert instruction is NODE_EXTRA_CA_CERTS  and this must be set as shown in order to use a custom CA. The CA_CERT environment variable is no longer in use for this purpose.
