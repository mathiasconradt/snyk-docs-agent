...
For the steps to scan a Helm chart using the Snyk CLI, see Helm charts.
For the steps to scan a Kustomize template using the Snyk CLI, see Kustomize files.
