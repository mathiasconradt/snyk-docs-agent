...
Fetch one/some/all the workspaces that the credentials have access to from SCM and create a workspaces list.
Fetch one/all repos under the fetched/provided workspaces.
