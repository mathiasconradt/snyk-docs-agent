By using the test command and the @snyk/protect package (replaced the snyk protect command), you are well set up to address known vulnerabilities. To address new vulnerabilities, which are constantly disclosed, use snyk monitor.
...
Log in to the Snyk Web UI, and go to your organization's project page (https://app.snyk.io/monitor/) to see the latest snapshot and history of your project.
